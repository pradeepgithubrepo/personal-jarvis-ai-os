...
* **Aligned / Matched Tables:** 11
* **Missing Tables on Remote:** 6 (`mobile_signals`, `qualified_signals`, `financial_facts`, `salary_events`, `salary_sources`, `merchant_profiles`)
...
2. Creates the `mobile_signals`, `qualified_signals`, `financial_facts`, `salary_events`, `salary_sources`, and `merchant_profiles` tables with matching column types, defaults, and primary/foreign keys.
